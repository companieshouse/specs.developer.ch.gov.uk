...
public class ValidationUtils {
    ...
    private static JsonNode getJsonNode(String jsonText)
            throws IOException {
    ...
    private static JsonNode getJsonNode(URL url)
            throws IOException {
        return JsonLoader.fromURL(url);
    } // getJsonNode(URL) ends

    private static JsonNode getJsonNodeFromResource(String resource)
            throws IOException {
        return JsonLoader.fromResource(resource);
    } // getJsonNode(Resource) ends

    private static JsonSchema getSchemaNode(String schemaText)
    ...
    private static JsonSchema getSchemaNode(URL schemaFile)
            throws IOException, ProcessingException {
        final JsonNode schemaNode = getJsonNode(schemaFile);
        return _getSchemaNode(schemaNode);
    ...
    private static void validateJson(JsonSchema jsonSchemaNode, JsonNode jsonNode)
    ...
    private static boolean isJsonValid(JsonSchema jsonSchemaNode, JsonNode jsonNode)
            throws ProcessingException {
        ProcessingReport report = jsonSchemaNode.validate(jsonNode);
