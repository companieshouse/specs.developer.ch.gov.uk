...
public class CLIHelper {
    ...
    static boolean containsOptionExtensions(Map<String, Object> extensions) {
        ...
        return option != null && StringUtils.isNotBlank(option.toString());
    }
    ...
    static String[] getArguments(Map<String, Object> extensions) {
        if (extensions.get("x-short-version") != null && StringUtils
                .isNotBlank(extensions.get("x-short-version").toString())) {
            return new String[]{extensions.get("x-short-version").toString(),
                    extensions.get("x-option").toString()};
        }
        ...
        for (String propertyName : properties.keySet()) {
            ...
            if (property instanceof BooleanSchema) {
                ...
                final List<String> values = new ArrayList<>(
                        Arrays.asList(inputElements.split(",")));
